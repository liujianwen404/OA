...
public class ProcessController extends BaseController {
    ...
    public String historyList(@PathVariable("instanceId") String instanceId, ModelMap mmap)
    {
        ...
        String deleteReason = "";
        String startUserId = "";
        HistoricProcessInstance historicProcessInstance = processService.getDeleteReason(instanceId);
        if (historicProcessInstance != null){
            deleteReason = historicProcessInstance.getDeleteReason();
            startUserId = historicProcessInstance.getStartUserId();
        }

        mmap.put("deleteReason", deleteReason);
        mmap.put("startUserId", startUserId);
