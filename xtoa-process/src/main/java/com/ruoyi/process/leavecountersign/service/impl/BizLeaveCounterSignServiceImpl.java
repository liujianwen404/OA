package com.ruoyi.process.leavecountersign.service.impl;
...
//                        .singleResult();
    ...
    public void complete(BizLeaveVo leave, Boolean saveEntity, String taskId, Map<String, Object> variables) {
        ...
        // 下一节点处理人待办事项
        bizTodoItemService.insertTodoItem(leave.getInstanceId(), leave.getTitle(), "leaveCounterSign",true,todoId,processInstance.getStartUserId());
    }
    ...
    public ProcessInstance submitApplyByCounterSign(BizLeaveVo entity, String applyUserId, Map<String, Object> variables) {
        ...
        // 下一节点处理人待办事项
        bizTodoItemService.insertTodoItem(processInstanceId, entity.getTitle(), "leaveCounterSign",processInstance.getStartUserId());
