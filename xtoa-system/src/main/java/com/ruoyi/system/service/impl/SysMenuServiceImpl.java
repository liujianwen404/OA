...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<SysMenu> selectMenusByUser(SysUser user,Boolean isDev)
    {
        ...
        {
            menus = menuMapper.selectMenusByUserId(user.getUserId(),isDev);
        }
    ...
    public List<SysMenu> selectMenuAllMC(Long userId)
    {
        List<SysMenu> menuList = menuMapper.selectMenuAllC();
         return menuList;
    }
    ...
    @Override
    public List<SysMenu> roleMenuData(SysRole role, Long userId)
    {
        Long roleId = role.getRoleId();
//        if(roleId == 1){
//            return menuMapper.selectMenuAllC();
//        }
        List<SysMenu> roleMenuList = menuMapper.selectMenuAllCByRoleId(roleId);
        return roleMenuList;
    }
