...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public int deleteRoleByIds(String ids) throws BusinessException
    {
        ...
        for (Long roleId : roleIds)
        {
            ...
            {
                throw new BusinessException(String.format("%1$s已分配员工,不能删除", role.getRoleName()));
            }
     ...
     */
    @Override
    public SysRole getRoleByket(String roleKey)
    {
     ...
     * @param role 角色信息
     */
    public static List<String> roleKeys = Arrays.asList("hr", "hrAdmin", "manager","finance");
    @Override
    ...
    @Override
    public List<Ztree> selectRoleListTree(Long roleId) {
