...
public interface SysUserMapper
{
    ...
    public List<SysUser> selectAllocatedListByKey(@Param("roleKey") String roleKey);
...
//    public int deleteUserById(Long userId);
     ...
     * @return 结果
     */
    String selectDeptLeaderByLoginName(String loginName);

    List<SysUser> selectUserListZtree(SysUser sysUser);

    List<SysUser> getUserRoleList(@Param("roleName") String roleName);

    List<SysUser> selectUserByIds(@Param("ids") Set<Long> ids);
