...
public class ShiroConfig
{
   ...
   /* @Bean
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        // 对静态资源设置匿名访问
      /*  if (ruoyiName.contains("web")){
            filterChainDefinitionMap.put("/**", "anon");
        }*/
        filterChainDefinitionMap.put("/oa-app/**", "anon");
        filterChainDefinitionMap.put("/webApi/**", "anon");
        filterChainDefinitionMap.put("/element-ui/**", "anon");
        filterChainDefinitionMap.put("/vue/**", "anon");
        filterChainDefinitionMap.put("/mint-ui/**", "anon");
